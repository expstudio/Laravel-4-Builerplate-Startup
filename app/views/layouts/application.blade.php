...
<html lang="en">
    <head>
        ...
        <title>EXP STUDIO | EXPERT EXPERIENCE EXPRESS WEBSITE DEVELOPER</title>
        <!-- Bootstrap Core CSS -->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 header-info-wrapper">
                            <ul class="list-inline">
                                <li><i class="icon-mobile-phone"></i> Mobile: (092) 218-9025</li>
                                <li><i class="icon-envelope"></i> Mail: <a href="mailto:contact@example.com">info@expstudio.net</a></li>
                            </ul>
                            <!-- /.list-inline -->
                        </div>
                        <!-- /.header-info-wrapper -->
                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html">EXP<span>STUDIO.</span></a>
                        </div>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="shop-1.html">Shop Layout 1</a></li>
                                        <li><a href="shop-2.html">Shop Layout 2</a></li>
                                        <li><a href="shop-3.html">Shop Layout 3</a></li>
                                        <li><a href="shop-4.html">Shop Layout 4</a></li>
                                        <li><a href="shop-item-1.html">Shop Item 1</a></li>
                                        <li><a href="shop-item-2.html">Shop Item 2</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="widget about-us">
                                <span class="footer-brand">EXP<span>Studio.</span></span>
