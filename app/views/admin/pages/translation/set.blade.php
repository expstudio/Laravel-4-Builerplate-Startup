...
<div class="row">
    <div class="col-lg-12">
        <h1>แก้ไขเพจภาษาอังกฤษ {{ HTML::image(url('/assets/images/en-flag.png'), 'Set English translation', array('style' => 'height:30px; width:auto;')) }}</h1>
...
{{ Form::model($page_translation, array('class' => 'form-horizontal', 'method' => 'POST', 'route' => array('admin..page_translations.store', $page->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('admin..pages.edit', 'Cancel', $page->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
