...
<div class="form-group">
    ...
    <div class="col-sm-10">
      {{ Form::submit('Edit', array('class' => 'btn btn-lg btn-primary', 'data-disable-with'=>"Updating...")) }}
      {{ link_to_route('admin..products.index', 'Cancel', $product->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
