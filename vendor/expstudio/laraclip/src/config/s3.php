...
return array(
	...
	*/
	...
	| is stored in a bucket.  If the specified bucket doesn't exist LaraClip will
	...
	| runtime. LaraClip will call that closure with attachment as the only argument.
	|
	*/
	...
	| bucket-owner-read, bucket-owner-full-control). The default for LaraClip is 
