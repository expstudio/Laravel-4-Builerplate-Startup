...
use Expstudio\LaraClip\Storage\StorageInterface;
...
class Attachment
{
	 ...
	 *
	 * @var Expstudio\LaraClip\Storage\StorageInterface.
	 */
	 ...
	 *
	 * @var Expstudio\LaraClip\Interpolator
	 */
	 ...
	 *
	 * @var Expstudio\LaraClip\UploadedFile
	 */
	 ...
	 * 
	 * @var Expstudio\LaraClip\File\Image\Resizer
	 */
	protected $resizer;

	/**
	 * An IOWrapper instance for converting file input formats (symfony uploaded file object
	 * arrays, string, etc) into an instance of Expstudio\LaraClip\UploadedFile.
	 * 
	 * @var Expstudio\LaraClip\IOWrapper
	 */
	protected $IOWrapper;
	 ...
	 * @var array
	 */
	protected $queuedForDeletion = array();
	 ...
	 * @var array
	 */
	protected $queuedForWrite = array();

	/**
	 * Constructor method
	 *
	 * @param Expstudio\LaraClip\Config $config
	 * @param Expstudio\LaraClip\Interpolator $interpolator
	 * @param Expstudio\LaraClip\File\Image\Resizer $resizer
	 * @param Expstudio\LaraClip\IOWrapper $IOWrapper
	 */
	 ...
	 *
	 * @return Expstudio\LaraClip\Interpolator
	 */
	 ...
	 * Accessor method for the uploadedFile property.
	 *
	 * @return Expstudio\LaraClip\File\Image\Resizer
	 */
	 ...
	 *
	 * @param  Expstudio\LaraClip\Storage\StorageInterface $storageDriver
	 * @return void
	 */
	...
	{
		// Storage methods
		$callable = array('remove', 'move');

		if (in_array($method, $callable)) {
			return call_user_func_array(array($this->storageDriver, $method), $parameters);
		}
	}
	...
	*/
	 ...
	 * @return void
	 */
	public function destroy($stylesToClear = array())
	{
	 ...
	 * @return void
	 */
	public function clear($stylesToClear = array())
	{
		if ($stylesToClear) {
