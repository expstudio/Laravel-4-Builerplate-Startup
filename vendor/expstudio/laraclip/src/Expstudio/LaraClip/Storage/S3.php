<?php namespace Expstudio\LaraClip\Storage;

use Expstudio\LaraClip\Attachment;
...
class S3 implements StorageInterface
{
	 ...
	 * 
	 * @var Expstudio\LaraClip\Attachment
	 */
	public $attachedFile;
	 ...
	 * @param Expstudio\LaraClip\Storage\S3ClientManager $s3ClientManager
	 */
