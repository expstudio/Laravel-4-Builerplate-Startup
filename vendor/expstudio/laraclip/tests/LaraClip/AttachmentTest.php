...
class AttachmentTest extends TestCase
{
	...
	public function testSetUploadedFile()
	{
		...
		$config = m::mock('Expstudio\LaraClip\Config', ['mockAttachment', []]);
		...
		$attachment = m::mock('Expstudio\LaraClip\Attachment')->makePartial();
	...
	{
		$storageDriver = m::mock('Expstudio\LaraClip\Storage\StorageInterface');
	...
	{
		$config = m::mock('Expstudio\LaraClip\Config', ['mockAttachment', ['public_path' => '/public']]);
	...
	{
		$config = m::mock('Expstudio\LaraClip\Config', ['mockAttachment', ['preserve_files' => false, 'styles' => ['foo' => '']]])->makePartial();
	...
	{
		$config = m::mock('Expstudio\LaraClip\Config', ['mockAttachment', ['preserve_files' => true]]);
	...
	{
		$mockUploadedFile = m::mock('Expstudio\LaraClip\File\UploadedFile');
		...
		$IOWrapper = m::mock('Expstudio\LaraClip\IOWrapper');
