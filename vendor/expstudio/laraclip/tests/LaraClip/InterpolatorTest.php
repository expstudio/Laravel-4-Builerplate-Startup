...
class InterpolatorTest extends TestCase
{
	...
	public function testInterpolate()
	{
		...
		$interpolator = m::mock('Expstudio\LaraClip\Interpolator', [$string])->makePartial();
	...
	protected function buildMockAttachment()
	{
		...
		$config = m::mock('Expstudio\LaraClip\Config', ['bar', ['default_style' => 'original']]);

		$attachment = m::mock('Expstudio\LaraClip\Attachment[originalFilename, getInstanceClass]');
