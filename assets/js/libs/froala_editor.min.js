...
! function (a) {
    ...
    b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI"], b.COLORS = ["#000000", "#444444", "#666666", "#999999", "#CCCCCC", "#EEEEEE", "#F3F3F3", "#FFFFFF", "#FF0000", "#FF9900", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#9900FF", "#FF00FF", "#F4CCCC", "#FCE5CD", "#FFF2CC", "#D9EAD3", "#D0E0E3", "#CFE2F3", "#D9D2E9", "#EAD1DC", "#EA9999", "#F9CB9C", "#FFE599", "#B6D7A8", "#A2C4C9", "#9FC5E8", "#B4A7D6", "#D5A6BD", "#E06666", "#F6B26B", "#FFD966", "#93C47D", "#76A5AF", "#6FA8DC", "#8E7CC3", "#C27BA0", "#CC0000", "#E69138", "#F1C232", "#6AA84F", "#45818E", "#3D85C6", "#674EA7", "#A64D79", "#990000", "#B45F06", "#BF9000", "#38771D", "#134F5C", "#0B5394", "#351C75", "#741B47", "#660000", "#783F04", "#7F6000", "#274E13", "#0C343D", "#073763", "#201211", "#4C1130"], b.image_commands = {
        ...
        var youtube_tag = a;
         ...
         if(youtube_tag.indexOf("youtube.com") > -1 || youtube_tag.indexOf("youtu.be") > -1)
         {
             var regExp = /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/;
             var match = youtube_tag.match(regExp);
            if (match && match[2].length == 11) {
                 youtube_tag = '<iframe width="680" height="500" src="//www.youtube.com/embed/' 
                             + match[2] + '" frameborder="0" allowfullscreen></iframe>';
            } else {
                 youtube_tag = '<iframe width="680" height="500" src="' 
                             + youtube_tag.replace("www.youtube.com/", "www.youtube.com/embed/") + '" frameborder="0" allowfullscreen></iframe>';
            }
         }
             
        this.$element.focus(), this.restoreSelection(), this.insertHTML(this.stripScript(youtube_tag)), this.saveUndoStep(), this.$bttn_wrapper.show(), this.hideVideoWrapper(), this.hide(), this.callback("insertVideo", [youtube_tag])
